...
const About = () => {
  return (
    <>
      ...
      >
        I graduated from The University of New South Wales with a bachelor's degree 
        in Computer Science, where I maintained a solid academic record and was listed 
        on the Dean's Honours List every year. With my excellent problem-solving skills 
